...
namespace Ariel_API.Controllers
{
    ...
    {
        private const string connectionString = "Server=localhost;Port=5432;UserId=postgres;Password=1313;Database=ExamenFinalDB;";
        ...
        public IActionResult Post([FromBody] LoginModel login)
        {
            ...
            if (usuario == null || usuario.contrasena != login.Password)
            {
                ...
                if ( cont >= 3)
                {
                    return StatusCode(403, "usuario bloqueado");
                }
                return Unauthorized($"inicio fallido, lleva {cont} de 3 intentos");
            }
